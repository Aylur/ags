...
export type FlowBoxProps<
    ...
    Attr = unknown,
    Self = FlowBox<Child, Attr>,
> = BaseProps<Self, Gtk.FlowBox.ConstructorProperties & {
    child?: Child
    children?: Child[]
    vertical?: boolean
}, Attr>;
...
export function newFlowBox<
    Child extends Gtk.Widget = Gtk.Widget,
    Attr = unknown
>(...props: ConstructorParameters<typeof FlowBox<Child, Attr>>) {
    return new FlowBox(...props);
}

// eslint-disable-next-line @typescript-eslint/no-unused-vars
export interface FlowBox<Child, Attr> extends Widget<Attr> { }
export class FlowBox<Child extends Gtk.Widget, Attr> extends Gtk.FlowBox {
    static {
        register(this, {
            properties: {
                'vertical': ['boolean', 'rw'],
    ...
    constructor(propsOrChildren: FlowBoxProps<Child, Attr> | Child[] = {}, ...children: Gtk.Widget[]) {
