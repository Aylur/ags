...
export default class Service extends GObject.Object {
    ...
    static pspec(name: string, type?: PspecType, handle?: PspecFlag): import("../../types/gtk-types/gobject-2.0.js").GObject.ParamSpecBoolean | import("../../types/gtk-types/gobject-2.0.js").GObject.ParamSpecDouble | import("../../types/gtk-types/gobject-2.0.js").GObject.ParamSpecFloat | import("../../types/gtk-types/gobject-2.0.js").GObject.ParamSpecInt64 | import("../../types/gtk-types/gobject-2.0.js").GObject.ParamSpecString | import("../../types/gtk-types/gobject-2.0.js").GObject.ParamSpecBoxed;
